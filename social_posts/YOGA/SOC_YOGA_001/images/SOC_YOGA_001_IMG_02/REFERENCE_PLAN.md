...
- image_asset_id: SOC_YOGA_001_IMG_02
- candidate_id: SOC_YOGA_001_IMG_02_CAND_01
...
| 2 | `BODY_01_FRONT_FULL_BODY_FACE_EXCLUDED_v7` | deterministic L0-derived | generation_input | Neck-below seated proportion and aligned legs | Face, skin, hair, outfit, scene |
| 3 | `OWNER_SPORT_YOGA_01_WORN_FRONT` | L2 approved | generation_input | Yoga outfit and light-skin-tone 15D matte hosiery, no footwear | Face, body identity, hair, scene |

## Face-safe declaration

- face visible: no; phone completely covers the face and mirror must not reveal it.
