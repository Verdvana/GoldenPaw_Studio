...
工作日下班后，天已基本黑。女主到商场内的公共瑜伽室上课：在公共连廊自拍抵达、在瑜伽室镜前坐在垫上自拍、最后拍下同一张垫与水杯的练习间隙细节。不是住宅、办公室、健身广告或性感化运动内容。
...
- face: no face is visible in any image; face, reflection and portrait are excluded.
- body: `BODY_01_FRONT_FULL_BODY_FACE_EXCLUDED_v7`, SHA-256 `59b585718760d9bd528dbc1e864b6fc9f9e271054e092933c9196a3876ae2e0b`.
...
- must preserve: full masked-face standing pose in image 01; feet and soles visibly reflected in image 02; mat/bottle detail and no face in image 03.
- safe areas: do not crop through phone, feet/sole reflection, bottle or mat edges; keep meaningful features inside the central 90%.
- text/logo/UI policy: no readable brand, studio name, store name, sign, QR code, watermark, fake UI or garbled text.
...
- approval evidence: user requested completion and generation of the specified three-image yoga post.

## Approval record — Image 01
...
- approved_path: `images/SOC_YOGA_001_IMG_03/approved/SOC_YOGA_001_IMG_03_APPROVED_v1.png`
- scope: L3 post-image approval only; not Canon and not a downstream visual input.

## Approval record — Image 02

- approved_by: user
- approval_date: 2026-09-19
- approval_evidence: “非常好，登记。”
- approved_path: `images/SOC_YOGA_001_IMG_02/approved/SOC_YOGA_001_IMG_02_APPROVED_v1.png`
- scope: L3 post-image approval only; not Canon and not a downstream visual input.
