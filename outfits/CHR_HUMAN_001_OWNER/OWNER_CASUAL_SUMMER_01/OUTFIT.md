...
Photos placed in `reference_inputs/garment_references/` define only the declared
garment, accessory, footwear, construction, color, pattern, fit, and material
properties. They must not define the owner's face identity, body geometry, skin,
hair, pose, lighting, background, or photography style. If a photo includes a
person, that person is not an identity reference.
