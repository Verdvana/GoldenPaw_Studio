# OWNER_WORK_SUMMER_01_DESIGN_REFERENCE_v006 — Generation Record
...
qa_comparison_only:
  - {asset_id: OWNER_WORK_SUMMER_01_DESIGN_REFERENCE_v005, path: "outfits/CHR_HUMAN_001_OWNER/OWNER_WORK_SUMMER_01/candidates/v005_design_reference/OWNER_WORK_SUMMER_01_DESIGN_REFERENCE_v005.png", purpose: "visual comparison only; never a generation input"}
authoritative_for:
...
original_candidate_path: outfits/CHR_HUMAN_001_OWNER/OWNER_WORK_SUMMER_01/candidates/v006_design_reference/OWNER_WORK_SUMMER_01_DESIGN_REFERENCE_v006.png
approved_path: outfits/CHR_HUMAN_001_OWNER/OWNER_WORK_SUMMER_01/approved/design_reference/OWNER_WORK_SUMMER_01_DESIGN_REFERENCE.png
sha256: 779f72cd508c47ddab224992d282bf3ac6d882adb8365608b208953ef353bee5
...
Show the full set: a black fitted short-sleeve top with a very low, clearly lowered rounded neckline, lower than v005 but still a rounded neckline and not a V-neck; a short skirt in a white base shifted slightly warm toward champagne, with medium-small black polka dots that are just slightly larger and slightly more spaced than v005—not large and not densely packed. Keep a balanced moderate dot size and density with visible base fabric between dots. The skirt remains narrowed and tailored: slim straight-to-soft-tapered silhouette with restrained ease toward the hem, clearly not umbrella-shaped, not strongly A-line and not bodycon or hip-hugging. No pleats, slit, belt or extra trim. Include one complete pair of gray ultra-sheer 15D matte pantyhose laid flat from waistband through both legs and feet. Natural skin tone must be perceptible through the gray veil while the matte textile remains readable, with continuous waist-to-toes construction and no toe-cap seam. Include the supplied gray-beige/light-champagne taupe square-toe pumps with rectangular vamp buckles and modest block heels.
...
Check no human or mannequin contamination; very low rounded neckline; moderately larger and sparser polka dots than v005; tailored non-umbrella, non-bodycon skirt silhouette; visibly ultra-sheer gray 15D matte hosiery; supplied shoe geometry; no extra wardrobe, logos or text. No promotion without explicit user approval.
