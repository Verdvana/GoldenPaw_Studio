...
- 对应提示词：`prompts/female-lead/outfit-anchor-sheet-v1.md`
- 生成方式：Codex 内置图像生成
...
- 身份基准：`assets/female-lead/key-art/female-lead-key-art-fresh-v1.png`
- 对应提示词：`prompts/female-lead/homewear-outfit-anchor-fresh-v1.md`
...
- 所有后续图片、分镜、首尾帧和视频提示词，只要居家拖鞋与脚趾入镜，都必须逐字加入 `prompts/_shared/closed-foot-pantyhose-toe-lock.md`；任何脚趾看似裸露的结果直接拒绝。
