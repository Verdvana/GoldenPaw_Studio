...
- natural inward/downward frown with visible realistic glabellar tension;
- both eyes naturally and symmetrically closed;
- restrained small-to-medium mouth opening, clearly open but not wide;
- simultaneous coexistence of all three transient expression actions.

## Explicit exclusions

- permanent skull, face width, brow, eye, nose, lip, jaw or chin geometry;
- teeth/oral anatomy, skin tone, age or permanent facial appearance;
- Hairstyle A, body, Calibration Outfit, lighting or background;
- other Expression components and the complete `owner_v1.0` release.

## QA evidence

Technical precheck confirmed the three user-defined actions simultaneously, with no smile, surprise, tear, scream, yawn or exaggerated pain distortion. Approved facial identity and visible contextual Hair-A/outfit presentation remain visually consistent. The user reviewed the displayed v002 and explicitly declared it qualified for registration.
