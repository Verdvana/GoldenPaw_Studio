...
`POSE_07` and `POSE_09` remain deferred and unapproved after repeated no-output generation blocks. The user explicitly moved work to Gate 7 on 2026-09-14; neither deferred Pose may be used downstream.
