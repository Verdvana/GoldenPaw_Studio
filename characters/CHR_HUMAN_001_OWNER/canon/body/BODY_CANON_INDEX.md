...
|---|---|---|---|---|---|
| `OWNER_BODY_01_FRONT_CANON_004` | front neutral standing, 168 cm / 60 kg target, approved hip/upper-thigh-root reconstruction and straighter lower legs | `approved/BODY_01_FRONT/OWNER_BODY_01_FRONT_CANON_004.png` | `eab2d082bc2a3f63137aa9caa6307cf35c8fa48ae70e1664adf7ae75c89fadac` | `OWNER_BODY_FRONT_CANON_L1` | `BODY_01_FRONT_METHOD.md` |
...
| `OWNER_BODY_06_BACK_CANON_002` | exact 180-degree back neutral standing, 168 cm / 60 kg target, front-aligned high-cut suit opening and rear contour | `approved/BODY_06_BACK/OWNER_BODY_06_BACK_CANON_002.png` | `f5a6d6cea3259ca3247d6b035595a67f5c50ada62f7fec9f011f4915b1895e87` | `OWNER_BODY_BACK_CANON_L1` | source/reference responsibilities preserved in v003 record |
...
The v016 candidate PNG was moved unchanged to the approved path after explicit user approval as `OWNER_BODY_01_FRONT_CANON_004.png`. It is the active front Body Master. `OWNER_BODY_01_FRONT_CANON_003` remains available as a superseded historical component; the previous `OWNER_BODY_01_FRONT_CANON_002` JPG is also retained as historical and is not an active routing target.
