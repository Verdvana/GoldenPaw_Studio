...
Active approved L1 components currently include `OWNER_FACE_01_FRONT_NEUTRAL_CANON_001`, `OWNER_FACE_02_LEFT_3Q_NEUTRAL_CANON_001`, `OWNER_FACE_03_RIGHT_3Q_NEUTRAL_CANON_001`, `OWNER_FACE_04_LEFT_PROFILE_NEUTRAL_CANON_001`, `OWNER_FACE_05_RIGHT_PROFILE_NEUTRAL_CANON_001`, `OWNER_BODY_01_FRONT_CANON_002`, and scoped `OWNER_HAIRSTYLE_B_APPEARANCE_CANON_001`. `OWNER_BODY_01_FRONT_CANON_001` remains a superseded historical approval. Each approval remains attribute-scoped and the complete `owner_v1.0` release is still unlocked.
